...
namespace ServicesSamples.WinRT.Infrastructure
{
    ...
    internal sealed class ApplicationStateService : IApplicationStateService
    {
        ...
        private static readonly DependencyProperty FrameSessionStateKeyProperty = DependencyProperty.RegisterAttached("_FrameSessionStateKey", typeof(string), typeof(ApplicationStateService), null);

        private static readonly DependencyProperty FrameSessionStateProperty = DependencyProperty.RegisterAttached("_FrameSessionState", typeof(Dictionary<string, object>), typeof(ApplicationStateService), null);
        ...
        /// </summary>
        internal Dictionary<string, object> SessionState { get; private set; } = new Dictionary<string, object>();
